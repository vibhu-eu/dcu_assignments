...
subtitle: "BAA 1030 Data Analytics and Story Telling Assignment #2"
...
#| message: false
#| code-fold: true
#| code-summary: "Core Library Setup & Raw files uploaded to Google Colab"
...
literacy_df = pl.read_csv("unicef_indicator_1.csv")
water_df    = pl.read_csv("unicef_indicator_2.csv")
...
#| message: false
#| code-fold: true
#| code-summary: "Get the information to write the story and explain the visualization"
#| results: asis
